...
class LineTracker(GeometryTracker, Text, Keyboard):
    ...
    def __init__(self, name, coordinates, parent, view=None, selectable=True,
        ...
        print('create line tracker', name)
        ...
        self.update_cb = None
        self.update(coordinates=coordinates, notify='6')
    ...
    def set_vertex_groups(self, groups):
        ...
        assert(sum(groups) == len(self.coordinates)),\
